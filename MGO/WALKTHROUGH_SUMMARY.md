...
### Bastrop County Walkthrough
1. Login with credentials
2. State: Texas
3. Jurisdiction: Bastrop County
4. Project Type: OSSF
...
1. Select Texas
2. Jurisdiction: Travis County 
3. Project Type: Permit
NOTE: There’s a bug to get everything to show up in one panel. Reach out to me to get there.
3. Click search permits (There’s more than 37,561)
