...
export const customerFormSchema = z.object({
  ...
  customer_type: z.union([customerTypeSchema, z.literal("")]).optional().transform(v => v === "" ? undefined : v),
  prospect_stage: z.union([prospectStageSchema, z.literal("")]).optional().transform(v => v === "" ? undefined : v),
