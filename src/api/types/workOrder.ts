...
export const workOrderFormSchema = z.object({
  ...
  estimated_duration_hours: z.any().transform((v) => { const n = Number(v); return v === "" || v === null || v === undefined || isNaN(n) ? undefined : n; }).pipe(z.number().min(0).optional()),
  // Assignment
  ...
  // Pumping details
  gallons_pumped: z.any().transform((v) => { const n = Number(v); return v === "" || v === null || v === undefined || isNaN(n) ? undefined : n; }).pipe(z.number().min(0).optional()),
  dump_site_id: z.string().optional(),
  dump_fee: z.any().transform((v) => { const n = Number(v); return v === "" || v === null || v === undefined || isNaN(n) ? undefined : n; }).pipe(z.number().min(0).optional()),
  // Pricing
  total_amount: z.any().transform((v) => { const n = Number(v); return v === "" || v === null || v === undefined || isNaN(n) ? undefined : n; }).pipe(z.number().min(0).optional()),
  // System type
