...
import { getPhotoQueueStats, getSignatureStats } from "@/lib/db";
...
export function OfflineBanner() {
  ...
  const totalPending =
    syncStatus.pendingCount + photoStats.pending + sigStats.pending;
  const hasFailures =
    photoStats.failed > 0 ||
    sigStats.failed > 0 ||
    ...
    if (!isOnline) {
      return (
        ...
        >
          ...
          <path
            fillRule="evenodd"
            d="M4.5 10.5A7.5 7.5 0 0112 3a7.5 7.5 0 016.15 3.19l-1.06 1.06A6 6 0 0012 4.5a6 6 0 00-6 6c0 .98.24 1.91.66 2.72L5.6 14.28A7.5 7.5 0 014.5 10.5z"
          />
          <path
            fillRule="evenodd"
            d="M12 6a4.5 4.5 0 00-4.5 4.5c0 .73.17 1.41.48 2.02l-1.06 1.06A6 6 0 016 10.5 6 6 0 0112 4.5a6 6 0 013.08.85l-1.06 1.06A4.5 4.5 0 0012 6z"
          />
  ...
  return (
    <div
      className={`${getBannerColor()} text-white px-4 py-2 text-sm transition-colors duration-300`}
    >
