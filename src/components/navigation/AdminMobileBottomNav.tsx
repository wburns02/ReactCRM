...
/**
 * Mobile bottom tab navigation for admin views.
 * Shows on screens < 768px (md breakpoint). Hidden on desktop via parent.
 *
 * 5 tabs: Dashboard, Work Orders, Customers, Schedule, Financial
 * These are the most-used admin sections for quick access.
 */
