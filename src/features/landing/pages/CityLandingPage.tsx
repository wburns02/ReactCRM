...
export function CityLandingPage({ config }: CityLandingPageProps) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-mac-dark-blue via-mac-navy to-mac-dark-blue overflow-hidden">
        ...
        <div id="city-content" className="relative container mx-auto px-4 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur px-4 py-2 rounded-full text-sm mb-6">
                ...
                <span>Now Serving {config.cityName} &amp; {config.county}</span>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-2 text-blue-200">
                  ...
                  <span>{config.cityName} &amp; Surrounding Areas</span>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-mac-dark-blue mb-4">
              Our Septic Services in {config.cityName}
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From routine pumping to emergency repairs, we handle all your
              septic system needs across {config.county}.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-mac-dark-blue mb-4">
              Serving {config.serviceAreaLabel}
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We proudly serve homeowners and businesses across {config.serviceAreaDescription}.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {config.servedCities.map((city) => (
      ...
      <Suspense fallback={<div className="min-h-[200px]" />}>
        <FAQSection
          ...
          serviceArea={config.serviceAreaDescription}
        />
      </Suspense>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start max-w-6xl mx-auto">
            <div className="text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                {activeOption === "book"
                  ? `Ready to Book Your ${config.cityName} Service?`
                  : `Ready for Reliable Septic Service in ${config.cityName}?`}
              </h2>
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-6">
                ...
                <a href={config.phoneTel} className="flex items-center gap-3 text-2xl font-bold hover:text-mac-light-blue transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Professional septic services serving {config.cityName} and {config.county}.
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-400">
                <p>
                  <a href={config.phoneTel} className="hover:text-white transition-colors">
                    {config.phone}
                  </a>
                </p>
                <p>{config.cityName}, {config.state}</p>
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                {config.servedCities.slice(0, 8).join(", ")}, and surrounding areas.
              </p>
            </div>
          </div>
