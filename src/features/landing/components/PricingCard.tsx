    ...
    <div className="bg-white border-2 border-primary/20 rounded-xl p-6 shadow-sm">
      ...
      <ul className="space-y-2 mb-4">
        ...
        <li className="flex items-center gap-2 text-gray-700">
          ...
          <span>Covers up to <strong>{includedGallons.toLocaleString()} gallons</strong></span>
        </li>
        <li className="flex items-center gap-2 text-gray-700">
          <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-blue-700">
              Just <strong>${overageRate.toFixed(2)}/gallon</strong> for any volume over {includedGallons.toLocaleString()} gallons.
              Our technician will measure on-site.
            </p>
          </div>
        </div>
      </div>
