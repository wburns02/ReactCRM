      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-text-muted">
            Configure automatic customer reminders
          </p>
        </div>
        <button
          ...
          <p className="text-2xl font-bold text-text-primary">
            {
              displayReminders.filter(
                (r: Reminder | (typeof defaultReminders)[0]) => r.enabled,
              ).length
            }
          </p>
        ...
        {isLoading ? (
          ...
          <div className="divide-y divide-border">
            {displayReminders.map(
              (reminder: Reminder | (typeof defaultReminders)[0]) => (
                <Link
                  key={reminder.id}
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                      <span
                        className={`text-sm ${reminder.enabled ? "text-success" : "text-text-muted"}`}
                      >
