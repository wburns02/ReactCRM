...
export function AllTemplates() {
  ...
  const smsTemplates = templates?.filter((t: Template) => t.type === 'sms') || [];
  const emailTemplates = templates?.filter((t: Template) => t.type === 'email') || [];
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted">{smsTemplates.length} templates</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-semibold text-text-primary">Email Templates</h2>
              <p className="text-sm text-text-muted">{emailTemplates.length} templates</p>
            </div>
          </div>
        </Link>
      </div>
