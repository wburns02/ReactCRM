...
export function FirstWorkOrderStep({
  ...
  const [step, setStep] = useState<
    "customer" | "service" | "schedule" | "review"
  >("customer");
  ...
  const selectCustomer = (
    customer: ImportedCustomer | null,
    name: string = "",
  ) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 mb-8">
        {(["customer", "service", "schedule", "review"] as const).map(
          (s, idx) => (
            <div key={s} className="flex items-center">
              <div
                className={cn(
                  ...
                  step === s
                    ...
                    : ["customer", "service", "schedule", "review"].indexOf(
                          step,
                        ) > idx
              ...
              >
                {["customer", "service", "schedule", "review"].indexOf(step) >
                idx
                  ? "✓"
                  : idx + 1}
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {activeServices.length > 0
              ...
              : // Default services if none configured
                ["Septic Pumping", "Inspection", "Repair", "Installation"].map(
                  (name) => (
                    <Card
                      key={name}
                      className={cn(
        ...
        <StepSection title="4. Review & Save">
          ...
          <div className="mt-6 p-4 bg-success/10 border border-success/20 rounded-lg">
            ...
            <p className="text-xs text-text-secondary">
              This work order will be saved when you complete onboarding. You
              can create more work orders from the Dispatch Board.
            </p>
          </div>
