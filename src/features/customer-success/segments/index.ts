...
export { FieldPicker, getFieldById, SEGMENT_FIELDS } from './components/FieldPicker.tsx';
export type { FieldDefinition, FieldCategory } from './components/FieldPicker.tsx';
export { OperatorSelect, getOperatorById, operatorNeedsSecondValue, operatorNeedsNoValue } from './components/OperatorSelect.tsx';
export { ValueInput } from './components/ValueInput.tsx';
export { RuleBuilder, createEmptyRule, validateRule, formatRuleDescription } from './components/RuleBuilder.tsx';
export { RuleGroup, RuleSummary, createEmptyRuleSet, validateRuleSet } from './components/RuleGroup.tsx';
export { SegmentCard, SegmentCardCompact } from './components/SegmentCard.tsx';
export { SegmentInsight, SegmentInsightCompact, AISuggestionsPanel } from './components/SegmentInsight.tsx';

// AI Guide - Friendly customer finder
export { AIGuide, default } from './AIGuide.tsx';
export { GuidedTour } from './GuidedTour.tsx';
export { JargonTranslator, JargonTooltip, withJargonTooltips } from './JargonTranslator.tsx';
