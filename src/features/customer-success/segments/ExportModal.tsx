          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                Export {customerCount} {customerCount === 1 ? 'customer' : 'customers'} from "{segment.name}"
              </p>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <div className="text-left">
                  <p className={cn(
                    'font-medium',
                    format === 'csv' ? 'text-primary' : 'text-gray-900 dark:text-white'
                  )}>
                    CSV
                  </p>
              ...
              >
                ...
                <div className="text-left">
                  <p className={cn(
                    'font-medium',
                    format === 'excel' ? 'text-primary' : 'text-gray-900 dark:text-white'
                  )}>
                    Excel
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
