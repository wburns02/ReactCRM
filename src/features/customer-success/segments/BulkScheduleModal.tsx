...
const ASSIGNMENT_METHODS = [
  {
    id: "auto",
    label: "Auto-Assign",
    description: "System assigns based on availability",
  },
  {
    id: "round_robin",
    label: "Round Robin",
    description: "Distribute evenly among team",
  },
  {
    id: "specific",
    label: "Specific Rep",
    description: "Assign to selected representative",
  },
];
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                Schedule service for {previewData.customerCount} customers in "
                {segment.name}"
              </p>
            </div>
            <button
              ...
              {PRIORITY_OPTIONS.map((option) => (
                <button
                  ...
                  onClick={() =>
                    setFormData({
                      ...formData,
                      priority: option.id as BulkScheduleOptions["priority"],
                    })
                  }
                  className={cn(
                ...
                <button
                  ...
                  onClick={() =>
                    setFormData({
                      ...formData,
                      assignmentMethod:
                        method.id as BulkScheduleOptions["assignmentMethod"],
                      assignedUserId: undefined,
                    })
                  }
                  className={cn(
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                onClick={() =>
                  setFormData({
                    ...formData,
                    createWorkOrders: !formData.createWorkOrders,
                  })
                }
                className={cn(
                  "relative inline-flex h-6 w-11 items-center rounded-full transition-colors",
                  formData.createWorkOrders
                    ? "bg-primary"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  {previewData.workOrdersToCreate}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Work Orders
                </p>
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  {previewData.estimatedHours.toFixed(0)}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Est. Hours
                </p>
