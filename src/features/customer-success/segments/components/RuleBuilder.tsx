  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-[180px]">
        ...
        <FieldPicker value={rule.field} onChange={handleFieldChange} />
      </div>
 ...
 * Validate a rule
 */
export function validateRule(rule: SegmentRule): {
  valid: boolean;
  error?: string;
} {
  if (!rule.field) {
  ...
  if (rule.operator === "between" && rule.value2 === undefined) {
    return {
      valid: false,
      error: 'Second value is required for "between" operator',
    };
  }
