...
export interface SurveyDeliverySettingsProps {
  ...
  onCheckEligibility?: (customerId: number) => Promise<{
    eligible: boolean;
    reason: string;
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdate({ ...config, preview_text: e.target.value })
                  }
                  className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onUpdate({ ...config, sender_name: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onUpdate({ ...config, sender_email: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                </div>
          ...
          {channel === "sms" && (
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onUpdate({ ...config, phone_number: e.target.value })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onUpdate({
                    ...config,
                    position: e.target.value as ChannelConfig["position"],
                  })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
              >
          ...
          {channel === "webhook" && (
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onUpdate({ ...config, webhook_url: e.target.value })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                placeholder="https://..."
              />
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          {(
            ["immediate", "scheduled", "event_triggered", "recurring"] as const
          ).map((type) => (
            <button
              key={type}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onUpdate({ ...timing, scheduled_date: e.target.value })
              }
              className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onUpdate({ ...timing, scheduled_time: e.target.value })
              }
              className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                onUpdate({ ...timing, event_trigger: e.target.value })
              }
              className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
            >
              <option value="">Select event...</option>
              <option value="support_ticket_resolved">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onUpdate({ ...timing, delay_hours: parseInt(e.target.value) })
              }
              className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
              min="0"
              max="168"
        ...
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-xs text-text-muted">
              Based on industry response rates
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              ...
              onChange={(e) =>
                onUpdate({ ...timing, optimal_time_enabled: e.target.checked })
              }
              className="sr-only peer"
            />
            ...
            {OPTIMAL_SEND_TIMES.slice(0, 3).map((slot, index) => (
              ...
              >
                ...
                <span className="text-success font-medium">
                  {slot.response_rate}% response rate
                </span>
              </div>
            ))}
          </div>
...
function ABTestPanel({
  ...
  const handleAddVariant = () => {
    ...
    const newSplit = newVariants.map(() =>
      Math.floor(100 / newVariants.length),
    );
    onUpdate({
      ...currentConfig,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-text-muted">
            Test different versions to optimize response rates
          </p>
        </div>
        <label className="relative inline-flex items-center cursor-pointer">
          <input
            ...
            onChange={(e) =>
              onUpdate({ ...currentConfig, enabled: e.target.checked })
            }
            className="sr-only peer"
          />
        ...
        <div className="space-y-4 pt-4 border-t border-border">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  onUpdate({
                    ...currentConfig,
                    test_metric: e.target.value as ABTestConfig["test_metric"],
                  })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...currentConfig,
                    test_duration_days: parseInt(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                min="1"
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-sm text-text-secondary">
              Automatically select winner at {currentConfig.winner_threshold}%
              confidence
            </span>
          </label>
        </div>
        ...
        <div className="space-y-4 pt-4 border-t border-border">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...config,
                    reminder_intervals: e.target.value
                      .split(",")
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onUpdate({ ...config, reminder_subject: e.target.value })
              }
              className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              onChange={(e) =>
                onUpdate({ ...config, stop_on_response: e.target.checked })
              }
              className="w-4 h-4 rounded border-border text-primary focus:ring-primary"
            />
            <span className="text-sm text-text-secondary">
              Stop reminders after response
            </span>
          </label>
        </div>
      )}
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-text-muted">
            Prevent over-surveying customers
          </p>
        </div>
        <label className="relative inline-flex items-center cursor-pointer">
          <input
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...config,
                    min_days_between_surveys: parseInt(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                min="1"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...config,
                    max_surveys_per_month: parseInt(e.target.value),
                  })
                }
                className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
                min="1"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onUpdate({
                  ...config,
                  exclude_new_customers_days: parseInt(e.target.value),
                })
              }
              className="w-full px-3 py-2 border border-border rounded-lg bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary"
              min="0"
            ...
            <p className="text-xs text-text-muted mt-1">
              Don't survey customers who joined less than{" "}
              {config.exclude_new_customers_days} days ago
            </p>
          </div>
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  onUpdate({ ...config, respect_opt_out: e.target.checked })
                }
                className="w-4 h-4 rounded border-border text-primary focus:ring-primary"
              />
              <span className="text-sm text-text-secondary">
                Respect survey opt-out preferences
              </span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  onUpdate({
                    ...config,
                    exclude_recently_churned: e.target.checked,
                  })
                }
                className="w-4 h-4 rounded border-border text-primary focus:ring-primary"
              />
              <span className="text-sm text-text-secondary">
                Exclude recently churned customers
              </span>
            </label>
          </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-warning">
                  Survey Fatigue Alert
                </p>
                <p className="text-xs text-text-secondary mt-0.5">
                  Some customers in your target segment have been surveyed
                  recently. Consider adjusting your settings or timing.
                </p>
              </div>
            </div>
          </div>
...
export function SurveyDeliverySettings({
  ...
  const [activeTab, setActiveTab] = useState<
    "channels" | "timing" | "targeting" | "advanced"
  >("channels");
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="font-medium text-text-primary">
                {config.reminders.enabled
                  ? `${config.reminders.max_reminders} max`
                  : "Disabled"}
              </p>
            </div>
            <div className="h-8 w-px bg-border" />
            <div>
              ...
              <p
                className={cn(
                  "font-medium",
                  config.fatigue.enabled ? "text-success" : "text-warning",
                )}
              >
      ...
      <div className="flex gap-1 border-b border-border">
        {(["channels", "timing", "targeting", "advanced"] as const).map(
          (tab) => (
            <button
              key={tab}
      ...
      <div className="bg-bg-card rounded-xl border border-border p-6">
        {activeTab === "channels" && (
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              {(Object.keys(config.channels) as DeliveryChannel[]).map(
                (channel) => (
                  <ChannelPanel
                    key={channel}
                    channel={channel}
        ...
        {activeTab === "timing" && (
          <TimingOptimizer
            ...
            onUpdate={(timing) => handleConfigUpdate({ timing })}
          />
        )}
          ...
          <div className="space-y-6">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleConfigUpdate({
                    target_segment_id: e.target.value
            ...
            <FatiguePanel
              config={config.fatigue}
              onUpdate={(fatigue) => handleConfigUpdate({ fatigue })}
            />
          </div>
        )}
        ...
        {activeTab === "advanced" && (
          <div className="space-y-6">
            <ABTestPanel
              config={config.ab_test}
              onUpdate={(ab_test) => handleConfigUpdate({ ab_test })}
            />
            <ReminderPanel
              config={config.reminders}
              onUpdate={(reminders) => handleConfigUpdate({ reminders })}
            />
          </div>
        )}
      </div>
