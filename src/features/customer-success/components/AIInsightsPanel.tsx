  ...
  return [
    {
      ...
      description:
        "Three customers scored 0-4 and mentioned specific issues with support response times. Risk of churn within 30 days.",
      urgency: "critical",
      category: "churn_risk",
      affectedCustomers: 3,
      confidence: 92,
    ...
    },
    {
      ...
      description:
        "Enterprise customers show a 12-point NPS decline over the past 2 weeks. Common theme: missing advanced reporting features.",
      urgency: "high",
      category: "trend",
    ...
    },
    {
      ...
      description:
        "78% of responses this week mentioned the new dashboard positively. Consider featuring in marketing.",
      urgency: "medium",
    ...
    },
    {
      ...
      description:
        "Post-support CSAT dropped below 4.0. Common complaint: long wait times for technical issues.",
      urgency: "high",
    ...
    },
    {
      ...
      description:
        "Only 12% of SMB customers responded to the Q1 survey. Consider shortening survey or adding incentive.",
      urgency: "medium",
      category: "engagement",
      confidence: 76,
...
export function AIInsightsPanel({
  ...
  const handleAction = useCallback(
    (insight: AIInsight, actionType: InsightActionType) => {
