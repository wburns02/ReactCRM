          ...
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="text-right">
              <p
                ...
                title={formatFullTimestamp(action.created_at)}
              >
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      >
                        ...
                        <option value="customer_satisfied">
                          Customer Satisfied
                        </option>
    ...
    <div className="space-y-0">
      {sortedActions.map((action, idx) => (
        <TimelineItem
          ...
          onComplete={
            onCompleteAction ? () => onCompleteAction(action.id) : undefined
          }
...
export function ActionHistory({ responseId, className }: ActionHistoryProps) {
  ...
  if (error) {
    return (
      <div
        className={cn(
          "p-4 bg-danger/10 rounded-lg text-danger text-sm",
          className,
        )}
      >
