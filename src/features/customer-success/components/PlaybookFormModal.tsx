...
const TRIGGER_TYPES: {
  ...
  { value: "manual", label: "Manual", description: "Triggered by CSM" },
  {
    ...
    label: "Health Score",
    description: "When health score changes",
  },
  {
    value: "segment_entry",
    label: "Segment Entry",
    description: "When customer enters segment",
  },
  { value: "event", label: "Event", description: "Based on customer event" },
  {
    value: "days_to_renewal",
    label: "Renewal Date",
    description: "Days before renewal",
  },
  ...
  useEffect(() => {
    if (playbook) {
      setFormData({
        ...
        trigger_type:
          (playbook.trigger_type as PlaybookTriggerType) || "manual",
        trigger_health_threshold:
          playbook.trigger_health_threshold || undefined,
        trigger_health_direction: playbook.trigger_health_direction as
          | "below"
          | "above"
          | undefined,
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                {isEditing
                  ...
                  : "Define a new customer success playbook"}
              </p>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
              {TRIGGER_TYPES.map((trigger) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setFormData({ ...formData, trigger_type: trigger.value })
                  }
                  className={cn(
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        trigger_health_direction: e.target.value as
                          | "below"
                          | "above",
                      })
                    }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    estimated_hours: parseInt(e.target.value) || undefined,
                  })
                }
                placeholder="e.g., 8"
                min={0}
