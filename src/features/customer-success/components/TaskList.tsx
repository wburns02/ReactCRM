...
> = {
  ...
  medium: {
    label: "Medium",
    className: "text-text-secondary border-text-muted",
    order: 2,
  },
  low: {
    label: "Low",
    className: "text-text-muted border-text-muted/50",
    order: 3,
  },
};
    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          {(
            ["active", "all", "pending", "in_progress", "completed"] as const
          ).map((status) => (
            <button
              key={status}
        ...
        <div className="space-y-2">
          {filteredTasks.map((task) => (
            <TaskCard
              ...
              onComplete={
                onCompleteTask ? () => onCompleteTask(task) : undefined
              }
