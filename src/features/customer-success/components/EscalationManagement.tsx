...
const sampleEscalations: Escalation[] = [
  {
    ...
    notes: [
      {
        ...
        content: "Investigating database connection issues",
    ...
    timeline: [
      ...
      },
      {
        ...
        actor: "Auto-routing",
        timestamp: "2026-01-06T08:31:00Z",
      },
      {
        id: 3,
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div
            className={cn(
              "p-2 rounded-lg",
              escalation.type === "retention"
                ? "bg-danger/10 text-danger"
                : escalation.type === "executive"
      ...
      <div className="flex items-center justify-between">
        ...
        <SLAIndicator
          dueAt={escalation.sla_due_at}
          breached={escalation.sla_breached}
        />
      </div>
...
function EscalationMetrics({ escalations }: { escalations: Escalation[] }) {
  ...
  const avgResolutionTime =
    resolved.length > 0
      ? resolved.reduce((sum, e) => sum + (e.resolution_time_hours || 0), 0) /
        resolved.length
      : 0;
    ...
    <div className="grid grid-cols-4 gap-4">
      ...
      <div className="bg-bg-card rounded-xl border border-border p-4 text-center">
        <p
          className={cn(
            "text-3xl font-bold",
            breached > 0 ? "text-danger" : "text-success",
          )}
        >
          {breached}
        </p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-text-muted">
            Track and resolve customer escalations with SLA monitoring
          </p>
        </div>
        <div className="flex items-center gap-3">
          <button
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    navigate(`/customers/${selectedEscalation.customer_id}`)
                  }
