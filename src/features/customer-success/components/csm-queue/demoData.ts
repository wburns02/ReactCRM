...
export const demoTaskTypes: CSMTaskType[] = [
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Did customer complete the missing step?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'What is the specific blocker?', gate_type: 'text', required: false, order: 2 },
      { id: 'q3', question: 'Is follow-up scheduled?', gate_type: 'boolean', required: true, order: 3 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Did customer confirm value received?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Is customer on track for renewal?', gate_type: 'select', required: true, options: ['Yes', 'No', 'Unsure'], order: 2 },
      { id: 'q3', question: 'Any expansion opportunities identified?', gate_type: 'boolean', required: true, order: 3 },
      { id: 'q4', question: 'Expansion notes', gate_type: 'text', required: false, order: 4 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Root cause identified?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Primary risk factor', gate_type: 'select', required: true, options: ['Low usage', 'Support issues', 'Budget', 'Champion left', 'Competition', 'Other'], order: 2 },
      { id: 'q3', question: 'Recovery action taken?', gate_type: 'boolean', required: true, order: 3 },
      { id: 'q4', question: 'Customer retained?', gate_type: 'select', required: true, options: ['Yes - saved', 'Yes - at risk', 'No - churned', 'Pending'], order: 4 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Feature adoption improving?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Additional training needed?', gate_type: 'boolean', required: false, order: 2 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'QBR meeting held?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Customer satisfied with ROI?', gate_type: 'select', required: true, options: ['Very satisfied', 'Satisfied', 'Neutral', 'Dissatisfied'], order: 2 },
      { id: 'q3', question: 'Next quarter goals set?', gate_type: 'boolean', required: true, order: 3 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Customer intends to renew?', gate_type: 'select', required: true, options: ['Yes', 'Likely', 'Unlikely', 'No', 'Unknown'], order: 1 },
      { id: 'q2', question: 'Pricing concerns?', gate_type: 'boolean', required: true, order: 2 },
      { id: 'q3', question: 'Expansion discussed?', gate_type: 'boolean', required: false, order: 3 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Issue understood?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Resolution provided?', gate_type: 'boolean', required: true, order: 2 },
      { id: 'q3', question: 'Customer sentiment improved?', gate_type: 'select', required: true, options: ['Yes', 'Somewhat', 'No', 'Unknown'], order: 3 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Expansion opportunity qualified?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Opportunity value ($)', gate_type: 'text', required: false, order: 2 },
      { id: 'q3', question: 'Next steps defined?', gate_type: 'boolean', required: true, order: 3 },
    ],
  ...
  },
  {
    ...
    quality_gates: [
      { id: 'q1', question: 'Cause of drop identified?', gate_type: 'boolean', required: true, order: 1 },
      { id: 'q2', question: 'Action plan created?', gate_type: 'boolean', required: true, order: 2 },
    ],
...
export const demoPlaybooks: CSMPlaybook[] = [
  {
    ...
    opening_script: "Hi [name], this is [csm] from ECBTX. I noticed you started setup but haven't gotten to [missing_step] yet. That's actually the part that unlocks the most value for your team. Do you have 10 minutes? I can walk you through it now.",
    key_questions: [
    ...
    objection_handlers: [
      { id: 'o1', trigger: "Been busy/traveling", response: "Totally understand. The setup takes just 5 minutes - can we knock it out right now while we're talking?", order: 1 },
      { id: 'o2', trigger: "I'll do it later", response: "I hear you. The risk is that your team won't see value until this is done. Let's at least get started together.", order: 2 },
      { id: 'o3', trigger: 'Having technical issues', response: 'Let me help with that right now. Can you share your screen so we can troubleshoot together?', order: 3 },
      { id: 'o4', trigger: 'Not sure I need this', response: "That's fair to question. The reason this step matters is it connects your data to our insights engine. Can I show you what that looks like?", order: 4 },
    ],
  ...
  },
  {
    ...
    objection_handlers: [
      { id: 'o1', trigger: "Haven't had time to use it", response: "I understand time is limited. Let's identify one quick win you can achieve this week.", order: 1 },
      { id: 'o2', trigger: "It's more complicated than expected", response: "That's valuable feedback. Can you tell me which part was confusing? I'll make sure we address it.", order: 2 },
    ],
  ...
  },
  {
    ...
    objection_handlers: [
      { id: 'o1', trigger: 'Thinking of canceling', response: "I appreciate you being direct. Before you decide, can you help me understand what's not working? I may be able to fix it.", order: 1 },
      { id: 'o2', trigger: 'Not getting value', response: "That's on us. What did you expect that you're not seeing? Let's figure out how to get you there.", order: 2 },
      { id: 'o3', trigger: 'Too expensive', response: "I understand budget matters. Let's look at what you're actually using and see if there's a better fit.", order: 3 },
      { id: 'o4', trigger: 'Switching to competitor', response: "I'd hate to lose you. What does their solution offer that we don't? Sometimes we can match it.", order: 4 },
    ],
  ...
  },
  {
    ...
    opening_script: "Hi [name], it's been about two months now. I wanted to check how your team is progressing with the platform.",
    key_questions: [
    ...
    objection_handlers: [
      { id: 'o1', trigger: "Team isn't adopting", response: "Let's identify the blockers. Would a team training session help?", order: 1 },
    ],
    success_criteria: 'Adoption progress reviewed, gaps identified and addressed',
    estimated_duration_minutes: 20,
    is_active: true,
    updated_at: '2025-12-15T00:00:00Z',
  },
  {
    ...
    context_fields: ['usage_summary', 'roi_metrics', 'health_score', 'open_issues', 'expansion_opportunities'],
    opening_script: "Thank you for joining the QBR. Today I'd like to review the value we've delivered, discuss any open issues, and align on goals for next quarter.",
    key_questions: [
    ...
    objection_handlers: [
      { id: 'o1', trigger: "Haven't seen the ROI", response: "Let's look at the metrics together. Sometimes value shows up in ways we haven't measured yet.", order: 1 },
      { id: 'o2', trigger: 'Budget concerns for renewal', response: "I understand. Let's make sure you're getting maximum value from your current plan before discussing options.", order: 2 },
    ],
    success_criteria: 'QBR completed, renewal intent confirmed, next steps documented',
  ...
  },
  {
    ...
    context_fields: ['contract_value', 'renewal_date', 'health_score', 'usage_metrics', 'expansion_opportunities'],
    opening_script: "Hi [name], your renewal is coming up in [X] days. I wanted to connect to make sure everything is in order and discuss how we can continue supporting your success.",
    key_questions: [
    ...
    objection_handlers: [
      { id: 'o1', trigger: 'Need to think about it', response: "Of course. What questions can I answer to help you decide?", order: 1 },
      { id: 'o2', trigger: 'Looking at alternatives', response: "I'd love to understand what's driving that. Can we discuss what might keep you with us?", order: 2 },
      { id: 'o3', trigger: 'Need a discount', response: "Let me see what I can do. Can you help me understand your budget constraints?", order: 3 },
    ],
    success_criteria: 'Renewal intent confirmed or concerns documented for resolution',
  ...
  },
  {
    ...
    context_fields: ['nps_score', 'nps_comment', 'recent_tickets', 'health_score', 'tenure'],
    opening_script: "Hi [name], thank you for your honest feedback on our survey. You mentioned [paraphrase comment]. I'd like to understand more and see what we can do to make this right.",
    key_questions: [
    ...
    objection_handlers: [
      { id: 'o1', trigger: "Don't want to talk about it", response: "I respect that. If you change your mind, I'm here to help. Is there anything I can do via email instead?", order: 1 },
      { id: 'o2', trigger: "It's too late", response: "I understand your frustration. Before you go, can I try to make it right?", order: 2 },
    ],
    success_criteria: 'Issue understood, resolution provided or escalated, follow-up sentiment captured',
    estimated_duration_minutes: 20,
    is_active: true,
    updated_at: '2025-12-15T00:00:00Z',
  },
  {
    ...
    context_fields: ['current_plan', 'usage_metrics', 'health_score', 'team_size', 'growth_signals'],
    opening_script: "Hi [name], I've noticed your team has been getting great results. I wanted to explore if there are ways we could support your growth further.",
    key_questions: [
    ...
    objection_handlers: [
      { id: 'o1', trigger: 'No budget right now', response: "Understood. When do you typically plan for new investments? Let's schedule a follow-up.", order: 1 },
      { id: 'o2', trigger: 'Need to see more value first', response: "That makes sense. What would convince you? Let's set a success milestone.", order: 2 },
    ],
...
export const demoQueueTasks: CSMQueueTask[] = [
  ...
  // URGENT - NPS Detractor
  {
    ...
    started_at: null,
    completed_at: null,
    metadata: { nps_score: 3, nps_comment: 'Support is slow, features missing' },
  },
  ...
  // URGENT - Onboarding Stall
  {
    ...
    started_at: null,
    completed_at: null,
    metadata: { completed_steps: ['signup', 'profile'], missing_steps: ['integration', 'first_workflow'] },
  },
  ...
  // STANDARD - Expansion Opportunity
  {
    ...
    started_at: null,
    completed_at: null,
    metadata: { expansion_signals: ['3 new team members', 'Asking about enterprise features'] },
  },
...
export const demoTaskWithContext: CSMTaskWithContext = {
  ...
  customer: {
    ...
    contacts: [
      { name: 'John Smith', email: 'john@acmecorp.com', role: 'VP Operations', is_champion: true },
      { name: 'Sarah Johnson', email: 'sarah@acmecorp.com', role: 'IT Manager', is_champion: false },
    ],
  },
  interaction_history: [
    {
...
export function getPlaybookForTaskType(taskTypeId: number): CSMPlaybook | undefined {
