          ...
          <DialogBody className="space-y-4">
            <div className="bg-bg-muted rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                <span className="text-sm text-text-secondary">Current Quantity</span>
              ...
              {quantityChange !== 0 && (
                <>
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-border">
                    <span className="text-sm font-medium text-text-secondary">New Quantity</span>
                    <span className="text-lg font-semibold text-text-primary">
                      {newQuantity}
                    </span>
                  </div>
            ...
            <div className="space-y-2">
              ...
              {errors.quantity_change && (
                <p className="text-sm text-danger">{errors.quantity_change.message}</p>
              )}
