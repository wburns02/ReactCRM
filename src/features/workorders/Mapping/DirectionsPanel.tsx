...
function ManeuverIcon({
  ...
  const iconPaths: Record<ManeuverType, string> = {
    depart:
      'M12 2L4 12l1.41 1.41L11 7.83V22h2V7.83l5.59 5.58L20 12l-8-10z',
    arrive:
    ...
    'turn-sharp-left':
      'M16 5.83l-4-4V5H6v14h2V7h4v3.17l4-4z',
    'turn-sharp-right':
      'M8 5.83l4-4V5h6v14h-2V7h-4v3.17l-4-4z',
    straight:
    ...
    ramp:
      'M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z',
    'fork-left':
      'M14 4l-4 4 1.41 1.41L13 7.83V18h2V4z M10 20h4v-2h-4z',
    'fork-right':
      'M10 4l4 4-1.41 1.41L11 7.83V18H9V4z M10 20h4v-2h-4z',
    roundabout:
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-500">
              {formatDistance(calculatedDistance)} - {formatDuration(calculatedDuration)}
            </p>
          </div>
          {onToggleCollapsed && (
            <svg
