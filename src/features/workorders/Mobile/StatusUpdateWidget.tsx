    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          aria-label={
            showAllStatuses ? "Hide status options" : "Show all status options"
          }
        >
          <svg
            className={cn(
              "w-5 h-5 transition-transform",
              showAllStatuses && "rotate-180",
            )}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
      ...
      {canProgress && !showAllStatuses && (
        ...
        >
          ...
          <span>
            {isUpdating ? "Updating..." : STATUS_ACTION_LABELS[currentStatus]}
          </span>
        </Button>
      )}
