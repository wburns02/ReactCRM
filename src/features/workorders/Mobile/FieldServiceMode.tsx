        ...
        {activeTab === 'overview' && (
          <div className="space-y-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <p className="text-text-primary">{fullAddress || 'No address'}</p>
                {fullAddress && (
                  <Button
                    variant="primary"
                    size="lg"
                  ...
                  {workOrder.time_window_start && (
                    <div>
                      ...
                      <p className="font-medium">
                        {workOrder.time_window_start}
                        {workOrder.time_window_end && ` - ${workOrder.time_window_end}`}
                      </p>
                    </div>
                  )}
                  {workOrder.estimated_duration_hours && (
                    <div>
                      <p className="text-sm text-text-secondary">Est. Duration</p>
                      <p className="font-medium">{workOrder.estimated_duration_hours}h</p>
                    </div>
                  )}
                </div>
              </CardContent>
