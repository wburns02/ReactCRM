...
import { STATUS_COLORS, WORK_ORDER_STATUS_LABELS } from '@/api/types/workOrder.ts';
            ...
            <div className="space-y-1 max-h-[60px] overflow-y-auto">
              {dayWorkOrders.slice(0, 3).map((wo) => (
                ...
                >
                  ...
                  >
                    {wo.time_window_start?.slice(0, 5)} {wo.customer_name || `#${wo.customer_id}`}
                  </div>
                </button>
              ))}
              ...
              {dayWorkOrders.map((wo) => (
                ...
                >
                  ...
                  >
                    ...
                    <Badge variant={getStatusVariant(wo.status)} size="sm" className="mt-1">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="text-xs text-text-secondary mt-1">
                          {wo.time_window_start?.slice(0, 5)} - {wo.time_window_end?.slice(0, 5) || 'TBD'}
                          {wo.estimated_duration_hours && (
                            <span className="ml-2">({wo.estimated_duration_hours}h)</span>
                          )}
                        </div>
                        {wo.service_city && (
