 ...
 */
function groupDataByPeriod(data: RevenueDataPoint[], groupBy: GroupBy): RevenueDataPoint[] {
  ...
  data.forEach((point) => {
    ...
    existing.previousRevenue = (existing.previousRevenue || 0) + (point.previousRevenue || 0);
    existing.workOrders += point.workOrders;
    existing.previousWorkOrders = (existing.previousWorkOrders || 0) + (point.previousWorkOrders || 0);
      ...
      <Card className={`p-6 ${className}`}>
        ...
        <CardContent className="p-0">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-text-primary mb-2">No revenue data available</h3>
            <p className="text-text-secondary">Revenue data will appear once work orders are completed.</p>
          </div>
        </CardContent>
      </Card>
    );
        ...
        <defs>
          ...
          {showComparison && (
            <linearGradient id="previousGradient" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor={CHART_COLORS.gray} stopOpacity={0.2} />
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-text-secondary mt-1">
              Total: {formatCurrency(stats.totalRevenue)} from {stats.totalOrders} orders
            </p>
          </div>
