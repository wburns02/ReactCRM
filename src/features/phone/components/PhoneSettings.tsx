        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm">
              <div
                className={`w-2 h-2 rounded-full ${rcStatus?.connected ? "bg-success" : "bg-danger"}`}
              />
            ...
            <p className="text-text-muted text-sm mt-2">
              Rings your phone first, then connects to customer.
            </p>
          </div>
          <div
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm">
              <div
                className={`w-2 h-2 rounded-full ${twilioStatus?.connected ? "bg-success" : "bg-danger"}`}
              />
              <span className="text-text-secondary">
                {twilioLoading
                  ? "Checking..."
            ...
            <p className="text-text-muted text-sm mt-2">
              Direct outbound calls without ringing your phone.
            </p>
          </div>
        </div>
      </CardContent>
