    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-text-muted">Create and manage customer estimates</p>
        </div>
                ...
                {estimates?.map((estimate: Estimate) => (
                  <tr key={estimate.id} className="hover:bg-bg-hover">
                    <td className="px-4 py-3">
                      <div>
                        <p className="font-medium text-text-primary">{estimate.customer_name}</p>
                    ...
                    <td className="px-4 py-3 text-sm text-text-muted">{estimate.created_at}</td>
                    <td className="px-4 py-3 text-sm text-text-muted">{estimate.valid_until}</td>
