    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="md:hidden bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-2 flex justify-around">
          <Link to="/portal" className="text-xs text-text-secondary">
            Dashboard
          </Link>
          <Link
            to="/portal/work-orders"
          ...
          <Link to="/portal/invoices" className="text-xs text-text-secondary">
            Invoices
          </Link>
          <Link
            to="/portal/request-service"
          ...
          <Link to="/portal/profile" className="text-xs text-text-secondary">
            Profile
          </Link>
        </div>
      </nav>
