          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <Button
                size="lg"
                onClick={() =>
                  pendingInvoices[0] && handlePayInvoice(pendingInvoices[0].id)
                }
                      ...
                      <div className="mt-3 flex gap-6">
                        ...
                        {inv.amount_paid > 0 && (
                          <div>
                            ...
                            <p className="font-medium text-green-600">
                              $
                              {inv.amount_paid.toLocaleString("en-US", {
                                minimumFractionDigits: 2,
                              })}
                            </p>
                          </div>
                        ...
                        {!isPaid && (
                          <div>
                            ...
                            <p
                              className={`font-bold ${isOverdue ? "text-red-600" : "text-text-primary"}`}
                            >
                              $
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-text-muted mt-2">
            Payments are securely processed through Stripe. We do not store your
            card information.
          </p>
        </CardContent>
      </Card>
