          ...
          return (
            <div key={task.id} className="flex items-center gap-3 py-2 px-3 rounded-lg bg-bg-hover transition-colors">
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-medium bg-emerald-100 text-emerald-700 hover:bg-emerald-500 hover:text-white dark:bg-emerald-900/30 dark:text-emerald-400 dark:hover:bg-emerald-600 dark:hover:text-white transition-all flex-shrink-0"
              >
