    ...
    return (
      <Card className="p-6 mt-6 bg-gray-50">
        ...
        <p className="text-sm text-gray-400 mt-2">
          Property data becomes available when permits are matched to county
          assessor records.
        </p>
      </Card>
    );
  ...
  return (
    <div className="mt-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <dd className="text-gray-900">
                  {formatAcres(
                    property.lot_size_acres || property.calculated_acres,
                  )}
                </dd>
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-100">
                <div>
                  ...
                  <dd className="text-gray-700">
                    {formatCurrency(property.market_land)}
                  </dd>
                </div>
                <div>
                  ...
                  <dd className="text-gray-700">
                    {formatCurrency(property.market_improvement)}
                  </dd>
                </div>
              </div>
            )}
              ...
              <div className="pt-2 border-t border-gray-100">
                ...
                <dd className="text-gray-900">
                  ...
                  {property.last_sale_price &&
                    ` for ${formatCurrency(property.last_sale_price)}`}
                </dd>
              </div>
            )}
        ...
        <Card className="p-6">
          ...
          property.bedrooms ? (
            ...
            <p className="text-gray-500 text-sm">
              Building details not available. This data may be added when
              building permit records are integrated.
            </p>
          )}
        </Card>
      </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {all_permits.map((permit) => (
                  <tr
                    key={permit.id}
                    className={
                      permit.is_current ? "bg-blue-50" : "hover:bg-gray-50"
                    }
                  >
                    <td className="px-4 py-2 whitespace-nowrap">
                      <span
                        className={`font-medium ${permit.is_current ? "text-blue-700" : "text-gray-900"}`}
                      >
      ...
      <Card className="p-6 bg-gray-50 border-dashed">
        ...
        <p className="text-gray-500 text-sm">
          No documents available yet. PDFs, photos, and attachments will appear
          here when integrated.
        </p>
      </Card>

      {/* Data Source Info */}
      <div className="text-xs text-gray-400 flex items-center gap-4">
        <span>Source: {property.source_portal_code || "Unknown"}</span>
        {property.scraped_at && (
          <span>
        ...
        {property.data_quality_score != null && (
          <span>Data quality: {property.data_quality_score}%</span>
        )}
      </div>
    </div>
  );
