#!/usr/bin/env python3
"""
UFO Abduction - I2V Animation from Reference Images
15 clips x 4 seconds = 60 seconds total
Uses exact prompts provided + reference images
"""
...
def build_i2v_workflow(image_filename, positive_prompt, output_name, seed=None):
    """Build I2V workflow - 65 frames for 4 seconds at 16fps"""
    if seed is None:
    ...
    return {
        ...
        # Block swap for memory management - 25 blocks for better throughput
        "10": {
        ...
        # Load VAE - must use Wan2_1 VAE for proper I2V channel detection
        "5": {
...
def generate_videos():
    print("=" * 60)
    print("UFO ABDUCTION - I2V FROM REFERENCE IMAGES")
    print("=" * 60)
    print("15 clips x 4 seconds = 60 seconds total")
    print("Resolution: 832x480, 65 frames, I2V 14B model")
    print("Using reference images + detailed prompts")
    print("=" * 60 + "\n")
    ...
    print("=" * 60)
    print("COMPLETE! Output: /home/will/ComfyUI/output/ufo_i2v_*.mp4")
    print("=" * 60)
